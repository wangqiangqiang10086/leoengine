...
(function (engine) {
    ...
    var CGObject = function CGObject() {
        _classCallCheck(this, CGObject);
    };

    var CGDisplayObject = function (_CGObject) {
        _inherits(CGDisplayObject, _CGObject);

        function CGDisplayObject() {
            ...
            _classCallCheck(this, CGDisplayObject);

            var _this = _possibleConstructorReturn(this, (CGDisplayObject.__proto__ || Object.getPrototypeOf(CGDisplayObject)).call(this));
        ...
        _createClass(CGDisplayObject, [{
            key: 'render',
            value: function render(parentCtx, offsetTime) {
                return;
            }
        }, {
            key: 'dispose',
        ...
        return CGDisplayObject;
    }(CGObject);

    var CGBitmap = function (_CGDisplayObject) {
        _inherits(CGBitmap, _CGDisplayObject);

        function CGBitmap(image, sx, sy, sw, sh, dx, dy, dw, dh) {
            ...
            var x = arguments.length > 11 && arguments[11] !== undefined ? arguments[11] : 0;
            var y = arguments.length > 12 && arguments[12] !== undefined ? arguments[12] : 0;
            var index = arguments.length > 13 && arguments[13] !== undefined ? arguments[13] : 0;
            var visible = arguments.length > 14 && arguments[14] !== undefined ? arguments[14] : true;

            _classCallCheck(this, CGBitmap);

            var _this2 = _possibleConstructorReturn(this, (CGBitmap.__proto__ || Object.getPrototypeOf(CGBitmap)).call(this, width, height, x, y, index, visible));

            var tmpCanvas = document.createElement('canvas');
            tmpCanvas.width = dw;
            tmpCanvas.height = dh;
            tmpCanvas.getContext('2d').drawImage(image, sx, sy, sw, sh, dx, dy, dw, dh);
            _this2.canvasCache = tmpCanvas;
            return _this2;
        }

        _createClass(CGBitmap, [{
            key: 'render',
            value: function render(parentCtx, offsetTime) {
                parentCtx.drawImage(this.canvasCache, this.x, this.y);
            }
        }, {
            key: 'dispose',
            value: function dispose() {
                this.canvasCache = null;
                _get(CGBitmap.prototype.__proto__ || Object.getPrototypeOf(CGBitmap.prototype), 'dispose', this).call(this);
            }
        }], [{
            key: 'fromImage',
            value: function fromImage(image) {
                return new Bitmap(image, 0, 0, image.width, image.height, 0, 0, image.width, image.height);
            }
        }]);
    ...
    var CGDisplayObjectContainer = function (_CGDisplayObject2) {
        _inherits(CGDisplayObjectContainer, _CGDisplayObject2);

        function CGDisplayObjectContainer() {
            var width = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
            var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            var x = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
            var y = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
            ...
            _classCallCheck(this, CGDisplayObjectContainer);

            var _this3 = _possibleConstructorReturn(this, (CGDisplayObjectContainer.__proto__ || Object.getPrototypeOf(CGDisplayObjectContainer)).call(this, width, height, x, y, index, visible));

            _this3._children = [];
            _this3._needSort = false;
            return _this3;
        }

        _createClass(CGDisplayObjectContainer, [{
            key: 'addChild',
            ...
            value: function removeChild(child) {
                var totalChild = this._children.length,
                    tmpChild = void 0;
            ...
            value: function render(parentCtx, offsetTime) {
                ...
                for (var i = 0; i < totalChild; i++) {
                    ...
                    if (child.visible) child.render(parentCtx, offsetTime);
                }
            }
        }, {
            key: 'dispose',
            value: function dispose() {
                ...
                this._children = null;
                _get(CGDisplayObjectContainer.prototype.__proto__ || Object.getPrototypeOf(CGDisplayObjectContainer.prototype), 'dispose', this).call(this);
            }
        }, {
            key: 'needSort',
            set: function set(value) {
        ...
        return CGDisplayObjectContainer;
    }(CGDisplayObject);

    var CGSprite = function (_CGDisplayObjectConta) {
        _inherits(CGSprite, _CGDisplayObjectConta);
        ...
        function CGSprite() {
            ...
            _classCallCheck(this, CGSprite);

            var _this4 = _possibleConstructorReturn(this, (CGSprite.__proto__ || Object.getPrototypeOf(CGSprite)).call(this, width, height, x, y, index, visible));

            var tmpCanvas = document.createElement('canvas');
            tmpCanvas.width = width;
            tmpCanvas.height = height;
            _this4._canvas = tmpCanvas;
            _this4._context = tmpCanvas.getContext('2d');
            return _this4;
        }

        _createClass(CGSprite, [{
            key: 'render',
            value: function render(parentCtx, offsetTime) {
                this._context.clearRect(0, 0, this.width, this.height);
                this.renderSelf(this._context, offsetTime);
                this.renderChildren(this._context, offsetTime);
                parentCtx.drawImage(this._canvas, this.x, this.y, this.width, this.height);
            }
        }, {
            key: 'renderSelf',
            ...
            key: 'renderChildren',
            value: function renderChildren(selfCtx, offsetTime) {
            ...
            value: function dispose() {
                this._context = null;
                this._canvas = null;
                _get(CGSprite.prototype.__proto__ || Object.getPrototypeOf(CGSprite.prototype), 'dispose', this).call(this);
            }
        }, {
            key: 'context',
            get: function get() {
        ...
        return CGSprite;
    }(CGDisplayObjectContainer);

    var CGSequenceFrame = function (_CGDisplayObject3) {
        _inherits(CGSequenceFrame, _CGDisplayObject3);

        function CGSequenceFrame() {
            var fps = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 12;
            ...
            _classCallCheck(this, CGSequenceFrame);

            var _this5 = _possibleConstructorReturn(this, (CGSequenceFrame.__proto__ || Object.getPrototypeOf(CGSequenceFrame)).call(this, width, height, x, y, index, visible));

            _this5._isPlaying = false;
            _this5._autoLoop = false;
            _this5._currentFrame = 0;
            _this5._totalFrames = 0;
            _this5._frames = [];
            _this5._fps = fps;
            _this5._intervalTime = 1000 / fps | 0;
            _this5._currntIntervalTime = 0;
            return _this5;
        }

        _createClass(CGSequenceFrame, [{
            key: 'play',
            value: function play() {
            ...
            value: function render(parentCtx, offsetTime) {
                //不使用离屏canvas
                parentCtx.drawImage(this._frames[this._currentFrame], this.x, this.y);
                if (this._isPlaying) {
                    if (this._currntIntervalTime <= 0) {
                        ...
                        if (this._currentFrame > this._totalFrames - 1) {
                            ...
                            var loopEndFunc = this._eventHandler.loopend;
                            if (loopEndFunc) loopEndFunc(this);
            ...
            value: function dispose() {
                this.stop();
                this.frames = null;
                _get(CGSequenceFrame.prototype.__proto__ || Object.getPrototypeOf(CGSequenceFrame.prototype), 'dispose', this).call(this);
            }
        }, {
            key: 'isPlaying',
            get: function get() {
            ...
            key: 'createFromImgs',
            value: function createFromImgs(imgs) {
                var sep = new CGSequenceFrame(12, imgs[0].width, imgs[0].height);
                sep.frames = imgs;
                sep.play();
                return sep;
            }
        ...
        return CGSequenceFrame;
    }(CGDisplayObject);

    var CGRole = function (_CGSprite) {
        _inherits(CGRole, _CGSprite);
        ...
        function CGRole() {
            ...
            _classCallCheck(this, CGRole);

            var _this6 = _possibleConstructorReturn(this, (CGRole.__proto__ || Object.getPrototypeOf(CGRole)).call(this, width, height, x, y, index, visible));

            _this6._sequenceContainer = {};
            _this6._currentSeq = null;
            _this6._currentDirectionCode = 0;
            _this6._currentAction = "stand";
            _this6._onActionDo = false;
            _this6._currentStep = 5;
            _this6._currentStep2 = 5 / 1.414 | 0;
            return _this6;
        }
        ...
        _createClass(CGRole, [{
            ...
            value: function action_do(action, directionCode) {
                ...
                this._currentSeq.addEventListener('loopend', function (seq) {
                    _this7._onActionDo = false;
                    _this7.action_stand(tmpDirectionCode);
                });
            ...
            value: function dispose() {
                ...
                _get(CGRole.prototype.__proto__ || Object.getPrototypeOf(CGRole.prototype), 'dispose', this).call(this);
            }
        }]);
    ...
    var CGStage = function (_CGDisplayObjectConta2) {
        _inherits(CGStage, _CGDisplayObjectConta2);

        function CGStage(canvasId) {
            var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
            var debugObj = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

            _classCallCheck(this, CGStage);

            var canvasObj = document.getElementById(canvasId);

            var _this8 = _possibleConstructorReturn(this, (CGStage.__proto__ || Object.getPrototypeOf(CGStage)).call(this, canvasObj.offsetWidth, canvasObj.offsetHeight));

            _this8.root = _this8;
            _this8._canvas = canvasObj;
            _this8._context = canvasObj.getContext('2d');
            _this8._lastTime = null;
            _this8._debug = debug;
            _this8._debugObj = debugObj;
            _this8._fps = 0;
            _this8._fpsLastTime = null;
            return _this8;
        }

        _createClass(CGStage, [{
            key: 'render',
            value: function render() {
                ...
                if (this._debug) {
                    var fpsOffsetTime = nowTime - this._fpsLastTime;
                    this._fps += 1;
                ...
                //console.log('stage');
                this._context.clearRect(0, 0, this.width, this.height);
                _get(CGStage.prototype.__proto__ || Object.getPrototypeOf(CGStage.prototype), 'render', this).call(this, this._context, offsetTime);
    ...
    engine.CGObject = CGObject;
    engine.CGDisplayObject = CGDisplayObject;
    engine.CGBitmap = CGBitmap;
    engine.CGDisplayObjectContainer = CGDisplayObjectContainer;
    engine.CGSprite = CGSprite;
    engine.CGSequenceFrame = CGSequenceFrame;
    engine.CGRole = CGRole;
    engine.CGStage = CGStage;
})(CGEngine);

exports.CGEngine = CGEngine;

},{"babel-polyfill":1}],328:[function(require,module,exports){
'use strict';

var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); //使用了 export default


var _ImagePreloader = require('./ImagePreloader');

var _ImagePreloader2 = _interopRequireDefault(_ImagePreloader);

var _cgengine = require('./cgengine');
...
(function () {
    ...
    new _ImagePreloader2.default(imgsMagicSrc, 'images/').then(function (res) {
        ...
        new _ImagePreloader2.default(imgsSrc, 'images/').then(function (res) {
            var imgSources = res.totalImages;
            var elementFps = document.getElementById("fps");

            var stage = new _cgengine.CGEngine.CGStage('canvas', true, {
                onFps: function onFps(fps) {
                    elementFps.innerText = "fps:" + fps;
                }
            });

            var role0 = new _cgengine.CGEngine.CGRole(100, 100, 100, 200);
            role0.initFrames(imgSources);

            stage.addChild(role0);

            var seqMagic = _cgengine.CGEngine.CGSequenceFrame.createFromImgs(imgMagicSource);
            seqMagic.play();
...
},{"./ImagePreloader":326,"./cgengine":327}]},{},[328])
